...
- ClinicPulse Triage turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser emergency clinic triage board called ClinicPulse Triage. It should help nurses register walk-in patients, assign triage priority, track room readiness, manage handoff notes, flag missing consent forms, handle offline intake recovery, show empty and error states, and every visible acti…
...
- Patient Operations - ClinicPulse Triage
- Patient Editor - ClinicPulse Triage
- Triage Board - ClinicPulse Triage
- Empty and Error Recovery - ClinicPulse Triage

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Patient Operations - ClinicPulse Triage
...
SCREEN_SPEC_2:
- exact_screen_title: Patient Editor - ClinicPulse Triage
...
SCREEN_SPEC_3:
- exact_screen_title: Triage Board - ClinicPulse Triage
- surface_id: SURF_TRIAGE_BOARD
- unique_canvas_caption: Triage Board: triage lanes, priority markers, room readiness, consent blockers, handoff notes, aging indicators, and next-action controls.
- purpose: Help users organize Patient work by triage priority, room readiness, consent, and handoff state when those signals are part of the requested product.
- required_content: triage lanes, priority markers, room readiness, consent blockers, handoff notes, aging indicators, and next-action controls.
- data_entities: Patient, ActivityEvent, Preference
...
- design_guidance: Represent triage state clearly; do not introduce service-desk queues or unrelated operations modules.

SCREEN_SPEC_4:
- exact_screen_title: Empty and Error Recovery - ClinicPulse Triage
...
3. SURF_TRIAGE_BOARD - Triage Board
   Purpose: Help users organize Patient work by triage priority, room readiness, consent, and handoff state when those signals are part of the requested product.
   Data: Patient, ActivityEvent, Preference
   Core content: triage lanes, priority markers, room readiness, consent blockers, handoff notes, aging indicators, and next-action controls.
   ...
   Guidance: Represent triage state clearly; do not introduce service-desk queues or unrelated operations modules.
